...
urlpatterns = patterns('',
    ...
    url(r'^success/(?P<pk>\d+)/$', csrf_exempt(SuccessView.as_view()), name='getpaid-platron-success'),
    url(r'^failure/(?P<pk>\d+)/$', csrf_exempt(FailureView.as_view()), name='getpaid-platron-failure'),
)
